...
addDecoder([void 0, 1], () => import("./raw-HFCE7CF5.js").then((m) => m.default));
addDecoder(5, () => import("./lzw-F6PFXRPL.js").then((m) => m.default));
addDecoder(6, () => {
  throw new Error("old style JPEG compression is not supported.");
});
addDecoder(7, () => import("./jpeg-OJ5HWA6D.js").then((m) => m.default));
addDecoder([8, 32946], () => import("./deflate-TAHL54DM.js").then((m) => m.default));
addDecoder(32773, () => import("./packbits-UPOPB7PA.js").then((m) => m.default));
addDecoder(
  34887,
  () => import("./lerc-YN3CKOTM.js").then(async (m) => {
    await m.zstd.init();
    return m;
  }).then((m) => m.default)
);
addDecoder(50001, () => import("./webimage-MFWVVIWK.js").then((m) => m.default));
  ...
  constructor(size = defaultPoolSize, createWorker) {
    ...
    if (size) {
      this._awaitingDecoder = createWorker ? Promise.resolve(createWorker) : new Promise((resolve) => {
        import("./decoder-EF7XYB7D.js").then((module) => {
